...
public class TestStatsLogger implements StatsLogger {
    ...
    public static final TestStatsLogger INSTANCE = new TestStatsLogger();
    ...
    static TestStatsLogger.TestOpStatsLogger testOpStatsLogger = new TestStatsLogger.TestOpStatsLogger();
    ...
    static TestStatsLogger.TestCounter testCounter = new TestStatsLogger.TestCounter();
